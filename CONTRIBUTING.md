Contributing to STOMP Core
============================

The STOMP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the STOMP Core project, and is not to be
confused with overall STOMP Network Protocol consensus changes.

Whether a pull request is merged into STOMP Core rests with the project merge
...
Patches that change STOMP consensus rules are considerably more involved than
...
Where a patch set proposes to change the STOMP consensus, it must have been
...
The project leader is the release manager for each STOMP Core release.
