...
from fake_stake.base_test import STOMP_FakeStakeTest

class zSTMPwrappedSerialsTest(STOMP_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSTMPs..." % DENOM_TO_USE)
