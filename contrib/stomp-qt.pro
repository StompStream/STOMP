...
RESOURCES += src/qt/stomp.qrc src/qt/stomp_locale.qrc

TRANSLATIONS += src/qt/locale/stomp_bg.ts \
                src/qt/locale/stomp_de.ts \
                src/qt/locale/stomp_en.ts \
                src/qt/locale/stomp_es.ts \
                src/qt/locale/stomp_fi.ts \
                src/qt/locale/stomp_fr.ts \
                src/qt/locale/stomp_it.ts \
                src/qt/locale/stomp_ja.ts \
                src/qt/locale/stomp_pl.ts \
                src/qt/locale/stomp_pt.ts \
                src/qt/locale/stomp_ru.ts \
                src/qt/locale/stomp_sk.ts \
                src/qt/locale/stomp_sv.ts \
                src/qt/locale/stomp_vi.ts \
                src/qt/locale/stomp_zh_CN.ts \
                src/qt/locale/stomp_zh_TW.ts
