...
In order to support loading of multiple wallets in stomp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is stomp.cpp.
...
Changes to stomp.cpp
----------------------
stomp.cpp is the entry point into stomp-qt, and as such, will require some minor modifications to provide hooks for
