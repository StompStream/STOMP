...
1. Clone the STOMP Core source code:

        git clone https://github.com/stomp-project/stomp
        cd stomp
...
STOMP Core is now available at `./src/stompd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/STOMP"

    touch "/Users/${USER}/Library/Application Support/STOMP/stomp.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/STOMP/stomp.conf"

The first time you run stompd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/stompd -daemon # Starts the stomp daemon.
    ./src/stomp-cli --help # Outputs a list of command-line options.
    ./src/stomp-cli help # Outputs a list of RPC commands when the daemon is running.
