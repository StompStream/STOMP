...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/StompStream/STOMP/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign PIVX Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit stomp=v${VERSION} ../stomp/contrib/gitian-descriptors/gitian-osx.yml
...
- Detached signatures will then be committed to the [stomp-detached-sigs](https://github.com/StompStream/stomp-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/StompStream/STOMP/releases/new) with a link to the archived release notes.
