...
extern UniValue DoZstmpSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzstmpseed(const UniValue& params, bool fHelp);
extern UniValue getzstmpseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzstmp(const UniValue& params, bool fHelp);
extern UniValue dzstmpstate(const UniValue& params, bool fHelp);
