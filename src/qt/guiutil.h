...
/** Utility functions used by the STOMP Qt UI.
 */
namespace GUIUtil
{
...
// Render STOMP addresses in monospace font
...
// Parse "stomp:" URI into recipient object, return true on successful parsing
