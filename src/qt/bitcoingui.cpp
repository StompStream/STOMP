                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("STOMP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a STOMP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and stomp: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSTMP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About STOMP Core"), this);
    aboutAction->setStatusTip(tr("Show information about STOMP Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for STOMP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your STOMP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified STOMP addresses"));
    ...
    openAction->setStatusTip(tr("Open a STOMP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the STOMP Core help message to get a list with possible STOMP command-line options"));
...
//        toolbar->widgetForAction(spacer)->setObjectName("ToolbarSpacer");
        ...
        logo->setPixmap(QPixmap(QString::fromUtf8(":/images/stomp_logo_horizontal")));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("STOMP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to STOMP network", "", count));
}
...
{
    QString strTitle = tr("STOMP Core"); // default title
