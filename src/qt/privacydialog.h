...
public:
    ...
    void setZStmpControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzSTMP_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSTMP_clicked();
    void on_pushButtonZStmpControl_clicked();
