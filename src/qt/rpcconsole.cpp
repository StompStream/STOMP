                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSTMPPathCustom = GetArg("-zstmpbackuppath", "");
    ...
    if(!strzSTMPPathCustom.empty()) {
        ui->wallet_customzstmpbackuppath->setText(QString::fromStdString(strzSTMPPathCustom));
        ui->wallet_customzstmpbackuppath_label->setVisible(true);
        ui->wallet_customzstmpbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSTMPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the STOMP RPC console.") + "<br>" +
