...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::STMP);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeStompAmount"))
        SoftSetArg("-anonymizestompamount", settings.value("nAnonymizeStompAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in stomp.cpp during shotdown to also remove the window positions
