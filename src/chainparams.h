 ...
 * STOMP system. There are three: the main network on which people trade goods
...
public:
    ...
    int StompBadBlockTime() const { return nStompBadBlockTime; }
    int StompBadBlocknBits() const { return nStompBadBlocknBits; }
 ...
 // STOMP
    ...
    std::string GetDevFundAddress() const { return  strDevFundAddress; }
        /** Address of rewards fund */
    std::string GetRewardFundAddress() const { return  strRewardFundAddress; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nStompBadBlockTime;
    unsigned int nStompBadBlocknBits;
    ...
    std::string strRewardFundAddress;
