...
#ifndef STOMP_ZSTMPTRACKER_H
#define STOMP_ZSTMPTRACKER_H
...
public:
    CzSTMPTracker(std::string strWalletFile);
    ~CzSTMPTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSTMPWallet* zSTMPWallet = NULL);
