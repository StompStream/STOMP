...
#ifndef STOMP_ZSTMPWALLET_H
#define STOMP_ZSTMPWALLET_H
...
public:
    CzSTMPWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSTMP(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSTMP(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
